...
<body>
    <header>
        <div class="col-md-6">
            <img src="mentor.png" alt="MentorU Logo" class="mentoru-logo img-fluid">
        </div>
                ...
                <tbody>
                    <?php foreach ($menteeData as $mentee): ?>
                        <tr>
                            ...
                            <td>
                                <a href="view_students.php?id=<?php echo $mentee['id']; ?>"
                                    class="btn btn-primary view-students-btn">View Students</a>
                            </td>
                            <td>
                            ...
                            <script>
                                document.querySelectorAll('.view-students-btn').forEach(button => {
                                    button.addEventListener("click", function (event) {
                                        ...
                                        // Get the ID value from the 'id' attribute of the button's parent row
